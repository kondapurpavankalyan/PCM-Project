...
public class H2P_SI_Automation extends TestBase {

	public static int pn = 1199755;
	public static int pid = 1199755;
	...
	public void H2PSIconnection(String protocol) throws Exception {
		...
		if (protocol.equalsIgnoreCase("FTP")) {
			...
			Thread.sleep(1000);
			FTPUsernameData.sendKeys(Keys.chord(Keys.CONTROL, "a"), "user" + pn++);
			FTPPwdData.sendKeys(Keys.chord(Keys.CONTROL, "a"), "Pass" + pn++);
			Thread.sleep(1000);
			FTPInDirectoryData.sendKeys(Keys.chord(Keys.CONTROL, "a"), "/in");
			FTPOutDirectoryData.sendKeys(Keys.chord(Keys.CONTROL, "a"), "/out");
			Thread.sleep(1000);
			...
			Thread.sleep(2000);
			FTPSUsernameData.sendKeys(Keys.chord(Keys.CONTROL, "a"), "FTPSUsername12" + pn++);
			FTPSPwdData.sendKeys(Keys.chord(Keys.CONTROL, "a"), "FTPSPassword123" + pn++);
			Thread.sleep(1000);
			FTPSInDirectoryData.sendKeys(Keys.chord(Keys.CONTROL, "a"), "/in");
			FTPSOutDirectoryData.sendKeys(Keys.chord(Keys.CONTROL, "a"), "/out");
			Thread.sleep(1000);
			...
			SFTPUserNameData.sendKeys(Keys.chord(Keys.CONTROL, "a"), "SFTPUserName" + pn++);
			SFTPPasswordData.sendKeys(Keys.chord(Keys.CONTROL, "a"), "SFTPPassword" + pn++);
			SFTPCharEncData.sendKeys(Keys.chord(Keys.CONTROL, "a"), "SFTPCharencc" + pn++);

			Thread.sleep(1000);

			SFTPIndirData.sendKeys(Keys.chord(Keys.CONTROL, "a"), "/in");
			SFTPOutDirData.sendKeys(Keys.chord(Keys.CONTROL, "a"), "/out");
	...
	public void P2HSIconnection(String protocol) throws Exception {
