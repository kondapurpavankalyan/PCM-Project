...
public class FTPSpartnersetupPage extends TestBase {

	public String filename = "FILEPROCESS2022.txt";
	public String partnername = "FTPSpartner2022";
	public String applicationname = "FTPSapplication2022";
	...
	public String p2husername = "testingftps";
	...
	public FTPSpartnersetupPage() {
		PageFactory.initElements(driver, this);
	}

	public void FTPS_Protocoltype(String ConnectionType) throws Exception {
		...
		Thread.sleep(1000);
		DropDownSelection(ProtocolDD, "B2Bi-FTPS");
		Thread.sleep(2000);
		...
		if (ConnectionType.equalsIgnoreCase("H2P")) {
			...
			DropDownSelection(FTPSConnectionTypeDD, "Active");
			Thread.sleep(2000);
			...
			Thread.sleep(2000);
			FTPSUsernameData.sendKeys(Keys.chord(Keys.CONTROL, "a"), "admin");
			FTPSPwdData.sendKeys(Keys.chord(Keys.CONTROL, "a"), "password");
			Thread.sleep(1000);
			FTPSInDirectoryData.sendKeys(Keys.chord(Keys.CONTROL, "a"), partnerindir + "/in");
			FTPSOutDirectoryData.sendKeys(Keys.chord(Keys.CONTROL, "a"), partneroutdir + "/out");
			Thread.sleep(1000);
			...
			FTPSOutDir.sendKeys(Keys.chord(Keys.CONTROL, "a"), partneroutdir + "/out");
			Thread.sleep(1000);
			DropDownSelection(FTPSTransferTypeData, "Binary");
			Thread.sleep(2000);
			FTPSFileTypeData.sendKeys(Keys.chord(Keys.CONTROL, "a"), "FTPSFileType");
			Thread.sleep(1000);
	...
	public void ValidateAppMailbox() throws Throwable {
		...
		Thread.sleep(1000);
		MBFileTypeData.sendKeys(Keys.chord(Keys.CONTROL, "a"), "FTPS");
	...
	public void FTPS_FileType(String DirectionType, String TransferType) throws Exception {
	...
	public void InboundRules(String DirectionType) throws Throwable {
		...
		if (DirectionType.equalsIgnoreCase("INBOUND")) {
			...
			DropDownSelection(dropProperty1Data, "B2Bi-FTPS");
			Thread.sleep(2000);
	...
	public void SIDashboardConnection() throws Exception {
		...
		WebElement deployment = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//li//a[contains(text(),'Deployment')]")));
